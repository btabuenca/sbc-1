...
#	print("luz") 
	...
	sleep(espera)
	primer_nivel = leer(nivel_agua_1)
	segundo_nivel = leer(nivel_agua_2)
	if primer_nivel < 400 or segundo_nivel < 400:
		led(1, 1, 0)#Enciede naranja
	datos_nivel_agua = (primer_nivel + segundo_nivel)/2
	datos_nivel_agua = 1024 - datos_nivel_agua
	
	resultado = (100*((int(datos_nivel_agua)))/1024)
	resultado = int(resultado)
	print(resultado)
	if(resultado>0):
		print(str(resultado) + '%')
	if(resultado > 15):
		led(0, 0, 1) #Enciende azul si más 25 %
